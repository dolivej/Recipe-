...
const registerScreen = () => {
    const {createAccount, loadingAuth} = useContext(AuthContext);
                    ...
                    {!usingEmail && <View style={[globalStructureStyles.row, styles.buttonsWrap]}>
                        ...
                        >
                            <View style={[globalStructureStyles.row]}>
                                ...
                                <Text style={[globalTextStyles.subTitle ,styles.buttonText]}>Sign up with Google</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                            onPress={() => {}}
                        ...
                        >
                            <View style={[globalStructureStyles.row]}>
                                ...
                                <Text style={[globalTextStyles.subTitle ,styles.buttonText]}>Sign up with Facebook</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                            <Text style={[globalTextStyles.subTitle, styles.buttonOutlineText]}>Sign up with Email</Text>
                        </TouchableOpacity>
                        ...
                        >
                            <View style={[globalStructureStyles.row]}>
                                ...
                                <Text style={[globalTextStyles.subTitle, styles.backButtonText]}>Login</Text>
                            </View>
                        </TouchableOpacity>
                    </View>}
                    {usingEmail && <View style={[globalStructureStyles.row, styles.buttonsWrap]}>
                        ...
                        >
                            {!loadingAuth && <Text style={[globalTextStyles.subTitle, styles.buttonText]}>Sign up</Text>}
